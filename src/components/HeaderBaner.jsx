  ...
  return (
    <div className='container'>
      <div className='flex justify-between mt-12 gap-4'>
        {/* watch */}
        <div className='relative max-w-280 grow'>
          ...
          <div className='absolute top-6 md:top-16 lg:top-10  right-21.25 flex flex-col'>
            ...
            <Link to="/Shop/watch" className='text-[14px] flex items-center gap-2'>
        ...
        <div className='hidden lg:block relative  '>
          ...
          <Link to="/Shop/headphone" className='absolute top-28 right-7 flex items-end gap-1'>
            <span>خرید</span>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-chevron-down-left">
              <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
              <path d="M8 8v8h8"></path>
