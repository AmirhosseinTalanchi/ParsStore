...
export default function SliderBanner({img,toptitle,title,caption}) {
  return (
    <div className='rounded-xl mb-10 relative'>
      ...
      <button className='absolute right-10 md:right-20 top-15 md:top-30 lg:top-45 xl:top-56 text-[#1462CF] bg-[#FFFEFE] font-bold text-[10px] md:text-sm w-28 md:w-32 md:px-1 h-6 md:h-10 rounded-lg'>همین الان خرید کن</button>
    </div>
  )
}
